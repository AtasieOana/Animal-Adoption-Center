...
public class ProjectConstants {
    ...
    public static final String NO_RECORD_BEFORE = "There are no medical records before this date.";
    public static final String DELETED_RECORDS = "All medical records before this date have been deleted";
    ...
    public static final String RECORD_NOT_FOUND = "Medical record with id %s doesn't exist";
    ...
    public static final String ANIMAL_NOT_FOUND = "Animal with id %s doesn't exist";
    public static final String ANIMAL_ADOPTED = "Animal with id %s is already adopted";
    public static final String CAGE_FULL = "Cage with id %s is already full";
